            ...
            var handleActuators = function(e, body) {
                ...
                if (body.devices)
                {
                    body.devices.filter(data => did_filter(self.log,config,data)).forEach(function(data) {
                        ...
                        // blinds
                        if(["27601565","35000864","14234511","35000662","36500172","36500572_A","16234511_A","16234511_S","45059071","31500162","23602075","32000064","32000064_A","14236011","23782076"].includes(data.deviceNumber))
                        {
